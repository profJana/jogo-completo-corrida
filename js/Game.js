class Game {
    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
        ...
        if (index === player.index) {
          ...
          //se player tem a vida menor que 0
          //explosão(blast) recebe verdadeiro
          //movimento do player (playerMoving) recebe falso
      ...
      //se player está se movendo
      //atualizar a posição Y em + 5
      // atualizar o player
  ...
  handleFuel(index) {
    ...
    //se a gasolina(fuel) do player for menor que 0
    // mudar o gameState para 2
    //e executar o gameOver
